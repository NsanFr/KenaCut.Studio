...
export default function Footer({ onOpenOrderModal }) {
  ...
  return (
    <footer className="pt-20 pb-28 border-t border-white/10 bg-[#06070D] relative overflow-hidden text-xs text-slate-400">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pb-10 border-b border-white/10">
          <div className="p-4 rounded-2xl bg-white/[0.02] border border-white/10 flex items-start gap-3">
            ...
            <div>
              <h4 className="font-bold text-white text-sm">100% Non-AI Slop</h4>
              <p className="text-[11px] text-slate-400 mt-0.5">Dipahat manual oleh editor profesional berstandar viral.</p>
            </div>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-white/[0.02] border border-white/10 flex items-start gap-3">
            ...
            <div>
              <h4 className="font-bold text-white text-sm">Commercial Audio Library</h4>
              <p className="text-[11px] text-slate-400 mt-0.5">Semua BGM & SFX aman untuk monetisasi dan akun bisnis.</p>
            </div>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-white/[0.02] border border-white/10 flex items-start gap-3">
            ...
            <div>
              <h4 className="font-bold text-white text-sm">Gamified CRM Rewards</h4>
              <p className="text-[11px] text-slate-400 mt-0.5">Kumpulkan poin repeat order untuk diskon & prioritas 24 jam.</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-6 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="font-black text-base text-white">KenaCut Studio</div>
                <div className="text-[11px] text-slate-400">Micro-Agency Video Post-Production</div>
              </div>
            </div>
          ...
          <div className="md:col-span-3 space-y-3">
            <h5 className="font-bold text-white text-xs uppercase tracking-wider">Navigasi</h5>
            <ul className="space-y-2 text-xs">
              <li><a href="#showcase" className="hover:text-white transition-colors">Portofolio Video</a></li>
              <li><a href="#pipeline" className="hover:text-white transition-colors">Alur Kerja 4 Tahap</a></li>
              <li><a href="#crm-tiers" className="hover:text-white transition-colors">Sistem Member CRM (5.png - 7.png)</a></li>
              <li><a href="#estimator" className="hover:text-white transition-colors">Kalkulator Order & Harga</a></li>
            </ul>
          </div>

          {/* Contact */}
          <div className="md:col-span-3 space-y-3">
            <h5 className="font-bold text-white text-xs uppercase tracking-wider">Hubungi Kami</h5>
            ...
            <div className="pt-2">
              <button
                onClick={scrollToTop}
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-white/5 hover:bg-white/10 text-slate-300 hover:text-white transition-colors text-xs"
              >
